        ...
        return (
            <form onSubmit={handleSubmit} className={`${className} review-form`}>
                ...
                <div className='review-form__details review-details'>
                    ...
                    <div className='review-details__total review-detail review-detail'>
                        <div className='review-detail__title review-detail__title'>Total</div>
                        <div className='review-detail__price review-detail__price'>${subtotal + tax}</div>
                    </div>
